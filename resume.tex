...
\begin{minipage}[t][][b]{0.33\textwidth}~
	...
	\content{Experienced}
	Python \tb C \tb JavaScript \tb SCSS \tb Bash \\
	\content{Familiar}
	OCaml \tb Scala \tb Go \tb PHP \\
	\sectionsep
...
\begin{minipage}[t]{0.66\textwidth}
	...
	\begin{tightemize}
		...
		\item Amassed 51 stars on Github, and ~2k usages per month through JitPack.
	\end{tightemize}
	...
	\begin{tightemize}
		...
		\item Amassed 46 stars on Github, and over 100k downloads on Google Play.
	\end{tightemize}
	...
	\begin{tightemize}
		\item Led an Android app for selling phone cases online.
