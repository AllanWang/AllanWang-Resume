...
\begin{minipage}[t][][b]{0.33\textwidth}~
	...
	\content{Experienced}
	Python \tb C \tb JavaScript \tb React \tb SCSS \tb Bash \\
	\content{Familiar}
...
\begin{minipage}[t]{0.66\textwidth}
	...
	\begin{tightemize}
		...
		\item Amassed 82 stars on Github, and ~2k usages per month through JitPack.
	\end{tightemize}
	...
	\begin{tightemize}
		...
		\item Amassed 63 stars on Github, and over 100k downloads on Google Play.
	\end{tightemize}
