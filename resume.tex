...
\begin{minipage}[t]{0.66\textwidth}
	...
	\project{\mygithub{KAU}[Kotlin Android Utils]}{Open Source}{Jun 2017 - Present}
	\vspace{\topsep} % Hacky fix for awkward extra vertical space
	\begin{tightemize}
		\item[] \stats[stars=39, forks=6]
	...
	\project{\mygithub{Frost-for-Facebook}[Frost for Facebook]}{Open Source}{May 2017 - Present}
	\begin{tightemize}
		\item[] \stats[downloads=85000, stars=35, forks=13]
	...
	\project{\playstorelink{com.pitchedapps.material.glass.free}{Material Glass}}{Open Source}{Mar 2013 - Jun 2017}
	\begin{tightemize}
		\item[] \stats[downloads=680000, stars=10, forks=5]
